						...
						<div class="item active">
							<div class="img">
								<a href="/productDetails?game_id=<?php echo $igre[0]['game_id']; ?>"><img src="<?php echo $igre[0]['image']; ?>" class="girl img-responsive" alt="image not found" />
									<div class="text-box">
										<p><?php echo (strlen($igre[0]['description']) > 200 ? substr_replace($igre[0]['description'], "...", 200) : $igre[0]['description']); ?></p>
									</div>
								</a>
							</div>
						</div>
						<div class="item img">
							<div class="img">
								<a href="/productDetails?game_id=<?php echo $igre[1]['game_id']; ?>"><img src="<?php echo $igre[1]['image']; ?>" class="girl img-responsive" alt="image not found" />
									<div class="text-box">
										<p><?php echo (strlen($igre[1]['description']) > 200 ? substr_replace($igre[1]['description'], "...", 200) : $igre[1]['description']); ?></p>
									</div>
								</a>
							</div>
						</div>
						...
						<div class="item img">
							<div class="img">
								<a href="/productDetails?game_id=<?php echo $igre[2]['game_id']; ?>"><img src="<?php echo $igre[2]['image']; ?>" class="girl img-responsive" alt="image not found" />
									<div class="text-box">
										<p><?php echo (strlen($igre[2]['description']) > 200 ? substr_replace($igre[2]['description'], "...", 200) : $igre[2]['description']); ?></p>
									</div>
								</a>
							</div>
						</div>
			...
			<div class="col-sm-12">
				...
				<div class="col-sm-12 padding-right">
					<div class="category-tab">
						<!--category-tab-->
						<div class="col-sm-12">
							<h2 class="title text-center">TOP 4 GAMES OF ALL TIMES</h2>
